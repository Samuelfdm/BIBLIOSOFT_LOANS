...
public class BookLoanException extends RuntimeException {
    ...
    private void setMessages(ErrorType errorType) {
        switch (errorType) {
            ...
            case INVALID_BOOK:
                ...
                break;
            case STUDENT_ALREADY_HAS_BOOK:
                this.userMessage = "El estudiante ya tiene un préstamo activo de este libro.";
                this.developerMessage = "Intento de préstamo fallido. El estudiante ya tiene un préstamo activo de este libro.";
                break;
            case NO_LOAN_FOUND:
    ...
    public enum ErrorType {
        ...
        NOT_AVAILABLE,
        INVALID_BOOK,
        STUDENT_ALREADY_HAS_BOOK,  // Nuevo error añadido
        NO_LOAN_FOUND
    }
}
